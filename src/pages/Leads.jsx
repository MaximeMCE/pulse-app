...
const Leads = () => {
  ...
  const getColor = s =>
    ({ New: 'bg-blue-200 text-blue-800',
       ...
       Rejected: 'bg-red-200 text-red-800' }[s] ||
  ...
  const moveCampaign = (c,i,to) => {
    ...
    d[c].splice(i,1); if (!d[to]) d[to]=[]; d[to].push(item);
  ...
  return (
    <div className="p-6">
      ...
      {/* ——— GLOBAL CONTROLS ——— */}
      <form
        onSubmit={e => { e.preventDefault(); /* filters already apply */ }}
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <span
                        className={`inline-block px-2 py-1 mt-1 rounded text-sm ${getColor(lead.status)}`}
                      >
                  ...
                  <div className="flex gap-2 items-center">
                    ...
                    <label className="text-sm font-medium ml-4">Campaign:</label>
                    <select
                      className="border rounded px-2 py-1 text-sm"
                      value={camp}
